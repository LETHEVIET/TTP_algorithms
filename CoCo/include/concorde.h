...
int
    ...
    CCtsp_clique_delta (CCtsp_lpgraph *g, double *x, CCtsp_lpclique *c,
        double *delta),
    CCtsp_copy_lpcut_in (CCtsp_lpcut_in *c, CCtsp_lpcut_in *newz),
    ...
    CCtsp_lpcut_to_lpcut_in (CCtsp_lpcuts *cuts, CCtsp_lpcut *c,
        CCtsp_lpcut_in *newz),
    CCtsp_copy_lpclique (CCtsp_lpclique *c, CCtsp_lpclique *newz),
    CCtsp_copy_lpdomino (CCtsp_lpdomino *c, CCtsp_lpdomino *newz),
...
int
    CCtsp_copy_skeleton (CCtsp_skeleton *old, CCtsp_skeleton *newz),
